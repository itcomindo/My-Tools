    ...
    <div id="cf-item-wr">
        ...
        <div class="cf-item">
            <ul class="cf-items-list">
                ...
                <!-- word counter -->
                <li data-tool="word-counter"><a href="https://wordcounter.net/" target="_blank">WordsCounter</a></li>
        ...
        <div id="cf-output-textarea" class="cf-item">
            ...
            <small>automatic copied to your clipboard</small>
...
?>
    <div id="redirect">
        ...
        <div id="run-redirect" class="cf-btn">Run</div>
        <div id="redirect-close" class="cf-btn">Close</div>
    </div>
<?php
}
